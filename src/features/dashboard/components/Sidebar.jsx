...
function Sidebar() {
  ...
  return (
    <div
      ...
      } h-screen relative w-1/6 bg-gradient-to-br from-violet-600 to-violet-900 rounded-tr-3xl border-none flex flex-col items-center text-white text-center gap-6 pt-8 shadow-lg`}
    >
      <div
      ...
      <div className="flex flex-col w-full items-center gap-4">
        {menuItems.map((item) => (
          <div
            ...
            className={`w-4/5 py-2 px-4 flex items-center justify-start gap-2 rounded-full text-lg transition-transform transform hover:scale-105 ${
