        ...
        <div className="flex flex-col items-center w-full md:w-1/3 border-b md:border-b-0 md:border-r border-gray-700 p-4 md:p-8">
          ...
          <div className="mt-4 flex flex-col items-center">
            ...
            <button
              ...
              className={`mt-4 text-xl md:text-base px-10 py-2 md:px-5 text-white bg-green-600 rounded-lg font-semibold shadow-md transition-all duration-300 hover:scale-105 hover:bg-green-500 ${
